      ...
      <div className="container">
        <div className="about-grid">
          <div className="about-img">
            <img src="/images/about.jpg" alt="ATLAS Hotel" onError={(e) => {e.target.src='https://images.unsplash.com/photo-1542314831-c6a4d14d8c85?auto=format&fit=crop&w=800&q=80'}} />
